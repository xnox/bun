...
describe("deno_task", () => {
  describe("commands", async () => {
    ...
    TestBuilder.command`VAR=1 BUN_TEST_VAR=1 ${BUN} -e 'console.log(process.env.VAR)' && echo $VAR`
      .stdout("1\n\n")
      .runAsTest('VAR=1 BUN_TEST_VAR=1 ${BUN} -e \'console.log(process.env.VAR)\' && echo $VAR');
